...
const (
	...
	JavaUpdateLog            = "/root/shellscript/JavaUpdate.log"
	RunLinuxCmdScript        = "/root/shellscript/cmd.sh"
	RunLinuxCmdLog           = "/root/shellscript/cmd.log"
	CheckSystemLogScript     = "/root/shellscript/system_log.sh"
